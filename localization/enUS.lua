...
L["SETTINGS"]["AUTO_ARENA_TOOLTIP"] = "Automatically update targets of macro groups upon entering 3v3 arena or solo shuffle. (per character setting, requires reload when enabling or disabling)"
